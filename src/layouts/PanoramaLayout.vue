<template>
  <div class="paranoma-layout control-py">
    <text-image
      ...
      image="img/landing-page/banner-half-panorama1-1900.jpg"
      :border="true"
    >
      <div class="col-md-6 col-sm-10">
        <title-subtitle
          ...
          textDescription2="E como podemos tornar o mundo dos investimentos mais facil e acessivel?"
        />
        <q-btn
          class="q-mt-sm"
          flat
    ...
    <text-image
      ...
      image="img/landing-page/banner-half-panorama2-1900.jpg"
      :border="true"
    >
      <div class="col-md-6 col-sm-10">
        <title-subtitle
...
export default defineComponent({
  name: "PanoramaLayout",
  components: { TitleSubtitle, TextImage },
  setup() {},
});
</script>
